  ...
  return (
    <div className="flex flex-col w-64 bg-white border-r border-slate-200 h-full">
      ...
      <nav className="flex-1 py-4 overflow-y-auto">
        <div className="space-y-1">
          ...
          <Link href="/appointments">
            <a className={`sidebar-link ${location === '/appointments' ? 'active' : ''}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <Link href="/patients">
            <a className={`sidebar-link ${location.startsWith('/patient/') ? 'active' : ''}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <Link href="/messages">
            <a className={`sidebar-link ${location === '/messages' ? 'active' : ''}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <Link href="/medical-records">
            <a className={`sidebar-link ${location === '/medical-records' ? 'active' : ''}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="p-4 border-t border-slate-200">
        <Link href="/settings">
          <a className="flex items-center text-sm font-medium text-slate-600 hover:text-primary-700">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Link href="/login">
          <a className="flex items-center mt-3 text-sm font-medium text-slate-600 hover:text-primary-700">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
